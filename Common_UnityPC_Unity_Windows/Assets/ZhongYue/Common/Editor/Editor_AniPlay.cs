...
{
    public class Editor_AniPlay : EditorWindow
    {
        #region 创建自定义窗口
        ...
        private static void CreateWindow()
        {
            ...
            Editor_AniPlay aniWindow = (Editor_AniPlay)EditorWindow.GetWindowWithRect(typeof(Editor_AniPlay), theRect, false, "动画播放编辑");
            aniWindow.Show();
        }
        #endregion
