...
{
    public static class Manager_SceneManager
    {
        #region public
        ...
        public static int GetCurrentSceneIndex(int currentSceneIndex)
        {
            UnityEngine.SceneManagement.Scene scene = UnityEngine.SceneManagement.SceneManager.GetActiveScene();
        ...
        public static void LoadScenes(string sceneName) { UnityEngine.SceneManagement.SceneManager.LoadScene(sceneName); }
        public static void LoadScenes(int sceneIndex) { UnityEngine.SceneManagement.SceneManager.LoadScene(sceneIndex); }
        ...
        public static IEnumerator LoadAsyncSceneEvent(string sceneName, bool isDone = false)
        {
        ...
        public static IEnumerator LoadAsyncSceneEvent(int sceneIndex, bool isDone = false)
        {
            yield return new WaitForEndOfFrame();
            yield return new WaitForEndOfFrame();
            yield return null;
        ...
        /// 
        /// </summary>
        public static void SceneUnloaded()
        {
        ...
        private static void OnSceneUnloaded(UnityEngine.SceneManagement.Scene current)
        {
