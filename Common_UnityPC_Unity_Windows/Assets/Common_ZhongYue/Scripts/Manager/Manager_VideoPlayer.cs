...
{
    public static class Manager_VideoPlayer
    {
        #region 
        /// <summary> VideoPlayer 切换“VideoClip”后，第一次进行播放 </summary>
        public static void VideoPlayStart(UnityEngine.Video.VideoPlayer videoPlayer, UnityEngine.Video.VideoClip videoClip)
        {
        ...
        public static void VideoPlayAfterPause(UnityEngine.Video.VideoPlayer videoPlayer)
        {
            JudgeVideoPlayer(videoPlayer);
        ...
        public static void VideoPause(UnityEngine.Video.VideoPlayer videoPlayer)
        {
            JudgeVideoPlayer(videoPlayer);
        ...
        public static void VideoStop(UnityEngine.Video.VideoPlayer videoPlayer)
        {
            JudgeVideoPlayer(videoPlayer);
        ...
        public static float GetCurrentTime(UnityEngine.Video.VideoPlayer videoPlayer)
        {
            JudgeVideoPlayer(videoPlayer);
        ...
        public static bool GetVideoDone(UnityEngine.Video.VideoPlayer videoPlayer)
        {
            JudgeVideoPlayer(videoPlayer);
        ...
        public static void JudgeVideoPlayer(UnityEngine.Video.VideoPlayer videoPlayer)
        {
            if (videoPlayer == null)
            {
